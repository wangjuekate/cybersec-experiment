...
export function JellyBeans() {
  ...
  function handleChange(e: React.ChangeEvent<HTMLInputElement>) {
    player.round.set("guess", e.target.valueAsNumber as any);
  }
  ...
  let jelly: JSX.Element = <JellyBeanPile />;
  ...
  return (
    <div className="md:min-w-96 lg:min-w-128 xl:min-w-192 flex flex-col items-center space-y-10">
      ...
      {!isResultStage ? (
        <Slider
          value={player.round.get("guess") as any}
  ...
  return (
    <div className="h-96 w-96 pb-6">
      <div
        ...
        aria-label="Jelly Beans Pile"
      />
    </div>
  );
}

function PlayerScore(player: any, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void, isResultStage: boolean) {
  return (
